    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("career", models.ManyToManyField(blank=True, to="util.career")),
                ("coop_tool", models.ManyToManyField(blank=True, to="util.cooptool")),
                (
                    "groups",
                ...
                ("interest_field", models.ManyToManyField(blank=True, to="util.interestfield")),
                ("interest_trend", models.ManyToManyField(blank=True, to="util.interesttrend")),
                ("language", models.ManyToManyField(blank=True, to="util.language")),
                ("position", models.ManyToManyField(blank=True, to="util.position")),
                ("stack", models.ManyToManyField(blank=True, to="util.stack")),
                (
                    "user_permissions",
                    models.ManyToManyField(
                        blank=True,
