...
urlpatterns = [
    ...
    # signup 넣으면 가입용 인증번호, password_reset 넣으면 비번 재설정에 맞는 인증 번호 전달됩니다
    ...
    # --- 아이디·비밀번호 찾기 ---
    path("find_email/", views.find_email_view, name="find_email"),
    path("password_reset/", views.reset_password_view, name="reset_password"),  # 새 비번 설정
    # --- 팔로우 ---
