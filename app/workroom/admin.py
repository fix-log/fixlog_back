...
from app.workroom.models import CalendarEvent  # 일정 모델
from app.workroom.models import Issue  # 이슈 모델
from app.workroom.models import Workroom  # 워크룸 메인 모델
from app.workroom.models import WorkroomDesign  # 워크룸-디자인 중간테이블 모델
from app.workroom.models import WorkroomLanguage  # 워크룸-언어 중간테이블 모델
from app.workroom.models import WorkroomMember  # 워크룸 멤버 모델
from app.workroom.models import WorkroomPosition  # 워크룸-포지션 중간테이블 모델
from app.workroom.models import WorkroomReview  # 워크룸 리뷰 모델
from app.workroom.models import WorkroomStack  # 워크룸-스택 중간테이블 모델
...
class WorkroomAdmin(admin.ModelAdmin):
    ...
    # 읽기 전용으로 표시할 필드 설정
    readonly_fields = ("created_at",)  # 생성 시간은 변경 불가
...
class WorkroomPositionAdmin(admin.ModelAdmin):
    ...
    # 사이드바 필터로 제공할 필드 설정
    list_filter = ("position",)  # 포지션별 필터
    # 상단 검색창으로 검색할 필드 설정
    search_fields = ("workroom__name",)  # 워크룸 이름 검색
